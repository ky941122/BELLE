...
model_dir = "/nfs/a100-80G-14/kangyu/saved_models/Llama-2-13b_GSM8K_compression-by-gpt4"
...
with open(os.path.join(dst_dir, "Llama-2-13b_GSM8K_compression-by-gpt4.json"), 'w') as f:
    json.dump(output, f)
