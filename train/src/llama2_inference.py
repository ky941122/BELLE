...
model_dir = "/nfs/a100-80G-14/kangyu/saved_models/Llama-2-13b_GSM8K_full-train-full-gen_consistency"
...
with open(os.path.join(dst_dir, "Llama-2-13b_GSM8K_full-train-full-gen_consistency.json"), 'w') as f:
    json.dump(output, f)
