...
model_name_or_path="..."
reward_model_name_or_path="$BELLE_PATH/saved_models/chatmodel-ft-roleinjection_qwen_translated_ultra_shp_no-margin_multi-machine/checkpoint-2700"
...
accelerate launch \
    ...
    "$BELLE_PATH/train/src/entry_point/reject_sampling/step_2_rewarding.py" \
