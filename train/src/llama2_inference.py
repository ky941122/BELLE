...
model_dir = "/nfs/172.17.1.38/nvme4/kangyu/saved_models/Llama-2-13b_raw-cot_2000-samples"
...
with open(os.path.join(dst_dir, "Llama-2-13b_raw-cot_2000-samples.json"), 'w') as f:
    json.dump(output, f)
