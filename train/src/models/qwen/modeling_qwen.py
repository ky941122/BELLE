...
from src.models.qwen.configuration_qwen import QWenConfig
from src.models.qwen.qwen_generation_utils import (
    HistoryType,
    make_context,
    decode_tokens,
    get_stop_words_ids,
...
class QWenForSequenceClassification(QWenPreTrainedModel):
