...
model_dir = "/nfs/a100-80G-14/kangyu/saved_models/Llama-2-13b_GSM8K_k=100_T=1_n=40_round-2+correct-and-length-preference_sample-14w_DPO"
...
with open(os.path.join(dst_dir, "Llama-2-13b_GSM8K_k=100_T=1_n=40_round-2+correct-and-length-preference_sample-14w_DPO.json"), 'w') as f:
    json.dump(output, f)
