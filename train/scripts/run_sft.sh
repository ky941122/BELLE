...
model_name_or_path=$BELLE_PATH/saved_models/implicit_cot_lora_merged_llama2-7b
...
output_dir="$BELLE_PATH/saved_models/implicit_cot_merged-lora_llama2-7b_1e-5"
mkdir -p ${output_dir}
