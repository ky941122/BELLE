...
model_dir = "/nfs/10.232.64.3/nvme3/kangyu/saved_models/final_answer_model/checkpoint-112"
...
with open(os.path.join(dst_dir, "lora-merged_final_answer_model-checkpoint-112.json"), 'w') as f:
    json.dump(output, f)
