...
model_dir = "/nfs/a100-80G-14/kangyu/saved_models/Llama-2-13b_GSM8K_k=100_T=1_n=200_round-3"
...
with open(os.path.join(dst_dir, "Llama-2-13b_GSM8K_k=100_T=1_n=200_round-3.json"), 'w') as f:
    json.dump(output, f)
